...
{
    std::cout << std::setw(4) << i << std::setw(10) << datasets[0]->stars[i].luminance << std::setw(12) << datasets[0]->stars[i].center.x << std::setw(12) << datasets[0]->stars[i].center.y;
    std::cout << std::setw(20) << datasets[1]->stars[i].luminance << std::setw(12) << datasets[1]->stars[i].center.x << std::setw(12) << datasets[1]->stars[i].center.y << std::endl;
