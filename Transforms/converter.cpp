...
std::shared_ptr<Converter> Converter::Create(IBitmapPtr pSrcBitmap, PixelFormat dstPixelFormat)
{
    ...
    {
        return std::make_shared<Converter_<PixelFormat::RGB24, PixelFormat::Gray8>>(pSrcBitmap);
    }
    else if (pSrcBitmap->GetPixelFormat() == PixelFormat::RGB48 && dstPixelFormat == PixelFormat::Gray16)
    {
        return std::make_shared<Converter_<PixelFormat::RGB48, PixelFormat::Gray16>>(pSrcBitmap);
    }
...
{
    if ( srcPixelFormat == PixelFormat::RGB24 && dstPixelFormat == PixelFormat::Gray8 )
    {
        return std::make_shared<Converter_<PixelFormat::RGB24, PixelFormat::Gray8>>( nullptr );
    }
    else if ( srcPixelFormat == PixelFormat::RGB48 && dstPixelFormat == PixelFormat::Gray16 )
    {
        return std::make_shared<Converter_<PixelFormat::RGB48, PixelFormat::Gray16>>( nullptr );
    }
