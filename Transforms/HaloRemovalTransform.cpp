...
HaloRemovalTransform<pixelFormat>::HaloRemovalTransform( std::shared_ptr<Bitmap<pixelFormat>> pSrcBitmap, float intensity, float bgL, float peakHue, float sigma )
: BaseHaloRemovalTransform( pSrcBitmap, intensity, bgL, peakHue, sigma )
{
}

template<PixelFormat pixelFormat>
void HaloRemovalTransform<pixelFormat>::Run()
{
